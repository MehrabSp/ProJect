...
mysqli_multi_query($connect, "CREATE TABLE `user` (
  ...
  CREATE TABLE `music` (
	...
	`namepersian` varchar(35) NOT NULL,
  ...
  CREATE TABLE `singer` (
    `namepersian` varchar(35) PRIMARY KEY,
	`nameenglish` varchar(35) NOT NULL,
    `nummusic` varchar(20) NOT NULL,
	`nummusicsv` varchar(20) NOT NULL,
	`numalbum` varchar(20) NOT NULL,
	`numalbumsv` varchar(20) NOT NULL,
	`genre` varchar(20) NULL
  );
CREATE TABLE `like` (
