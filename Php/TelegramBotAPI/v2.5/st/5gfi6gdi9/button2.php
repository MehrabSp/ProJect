...
//---------------------------------------------------
$ds = file_get_contents("voote/$id.dok.txt");
$s = explode('|',$ds);
$d = file_get_contents("voote/$id.post.txt");
if($s[21] != null){
...
'inline_keyboard'=>[
[["text"=>"$s[1] $s[0]","callback_data"=>"voote1^$id^$s[2]"],["text"=>"$s[4] $s[3]","callback_data"=>"voote2^$id^$s[5]"]],
[["text"=>"$s[7] $s[6]","callback_data"=>"voote3^$id^$s[8]"],["text"=>"$s[10] $s[9]","callback_data"=>"voote4^$id^$s[11]"]],
[["text"=>"$s[13] $s[12]","callback_data"=>"voote5^$id^$s[14]"],["text"=>"$s[16] $s[15]","callback_data"=>"voote6^$id^$s[17]"]],
[["text"=>"$s[19] $s[18]","callback_data"=>"voote7^$id^$s[20]"],["text"=>"$s[22] $s[21]","callback_data"=>"voote8^$id^$s[23]"]],
],
])
]);
...
[["text"=>"$s[7] $s[6]","callback_data"=>"voote3^$id^$s[8]"],["text"=>"$s[10] $s[9]","callback_data"=>"voote4^$id^$s[11]"]],
[["text"=>"$s[13] $s[12]","callback_data"=>"voote5^$id^$s[14]"],["text"=>"$s[16] $s[15]","callback_data"=>"voote6^$id^$s[17]"]],
[["text"=>"$s[19] $s[18]","callback_data"=>"voote7^$id^$s[20]"]],
],
])
]);
$post_id = $post->result->message_id;
...
[["text"=>"$s[1] $s[0]","callback_data"=>"voote1^$id^$s[2]"],["text"=>"$s[4] $s[3]","callback_data"=>"voote2^$id^$s[5]"]],
[["text"=>"$s[7] $s[6]","callback_data"=>"voote3^$id^$s[8]"],["text"=>"$s[10] $s[9]","callback_data"=>"voote4^$id^$s[11]"]],
[["text"=>"$s[13] $s[12]","callback_data"=>"voote5^$id^$s[14]"]],
],
])
]);
$post_id = $post->result->message_id;
...
'inline_keyboard'=>[
[["text"=>"$s[1] $s[0]","callback_data"=>"voote1^$id^$s[2]"],["text"=>"$s[4] $s[3]","callback_data"=>"voote2^$id^$s[5]"]],
[["text"=>"$s[7] $s[6]","callback_data"=>"voote3^$id^$s[8]"]],
],
])
]);
$post_id = $post->result->message_id;
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[["text"=>"$s[1] $s[0]","callback_data"=>"voote1^$id^$s[2]"]],
],
])
]);
$post_id = $post->result->message_id;
