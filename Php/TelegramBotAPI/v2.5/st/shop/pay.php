...
<head>
    <meta charset="UTF-8">
    <title>خطا | Tm Quick</title>
    <script src="http://tm-quick.ir/js/jquery-3.3.1.min.js"></script>
    <script src="http://tm-quick.ir/js/TweenMax.min.js"></script>
    <link rel="stylesheet" href="http://tm-quick.ir/css/style.css?v=4.2">
	
	<!-- Favicon  -->
    <link rel="icon" href="http://tm-quick.ir/images/favicon.png">
</head>
<body>
    ...
    <div class="screen un">
        ...
        <a href="tg://resolve?domain=is_MahdiTaM">
            <button id="btnClick" class='backButton'>پشتیبانی تلگرام</button>
        </a>
    ...
    <script>
        const invert = true;
        const title = 'خطا'
        const message = 'درگاه پرداخت در دسترس نیست'
    </script>

    <script src="http://tm-quick.ir/js/script.js?v=4.2"></script>
